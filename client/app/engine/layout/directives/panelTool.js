(function() {
    ...
    panelExpand.$inject = ['$compile'];
    panelDismiss.$inject = ['$compile'];

    /**
     * ctPanelTool
     */
    function ctPaneltool() {

        var templates = {
            /* jshint multistr: true */
            collapse: '<a href=\'#\' class=\'btn btn-transparent btn-sm\' panel-collapse=\'\' ' +
            'tooltip-placement=\'top\' uib-tooltip=\'Collapse\' ng-click=\'{{panelId}} = !{{panelId}}\'' +
            'ng-init=\'{{panelId}}=false\'><i ng-if=\'{{panelId}}\' class=\'ti-plus\'></i><i ng-if=\'!{{panelId}}\'' +
            'class=\'ti-minus\'></i></a>',
            refresh: '<a href=\'#\' class=\'btn btn-transparent btn-sm\' panel-refresh=\'\' ' +
            'tooltip-placement=\'top\' uib-tooltip=\'Refresh\' data-spinner=\'{{spinner}}\'>' +
            '<i class=\'fa fa-circle-o\'></i></a>',
            expand: '<a href=\'#\' class=\'btn btn-transparent btn-sm hidden-sm hidden-xs\'' +
            'panel-expand=\'\'><i class=\'fa fa-expand\' ng-show=\'!isPanelFullscreen\'></i>' +
            '<i class=\'fa fa-compress\' ng-show=\'isPanelFullscreen\'></i></a>',
            dismiss: '<a href=\'#\' class=\'btn btn-transparent btn-sm\' panel-dismiss=\'\' ' +
            'tooltip-placement=\'top\' uib-tooltip=\'Close\'><i class=\'ti-close\'></i></a>'
        };
